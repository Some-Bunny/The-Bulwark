...
namespace ItemAPI
{
	...
	public static class SpriteBuilder1
	{
		...
		public static GameObject SpriteFromFile(string spriteName, GameObject obj = null)
		{
			...
			{
				result = SpriteBuilder1.SpriteFromTexture(textureFromFile, spriteName, obj);
			}
			return result;
		}
		...
		public static GameObject SpriteFromResource(string spriteName, GameObject obj = null, bool v = false)
		{
			...
			{
				result = SpriteBuilder1.SpriteFromTexture(textureFromResource, text, obj);
			}
			return result;
		}
		...
		public static GameObject SpriteFromTexture(Texture2D texture, string spriteName, GameObject obj = null)
		{
			...
			int newSpriteId = SpriteBuilder1.AddSpriteToCollection(spriteName, SpriteBuilder1.itemCollection);
			tk2dSprite.SetSprite(SpriteBuilder1.itemCollection, newSpriteId);
		...
		public static int AddSpriteToCollection(string resourcePath, tk2dSpriteCollectionData collection)
		{
			...
			tk2dSpriteDefinition tk2dSpriteDefinition = SpriteBuilder1.ConstructDefinition(textureFromResource);
			tk2dSpriteDefinition.name = textureFromResource.name;
			return SpriteBuilder1.AddSpriteToCollection(tk2dSpriteDefinition, collection);
		}
		...
		{
			return SpriteBuilder1.AddSpriteToCollection(spriteDefinition, SpriteBuilder1.ammonomiconCollection);
		}
